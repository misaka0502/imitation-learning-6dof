...
if __name__ == "__main__":
    ...
    parser.add_argument("--env", "-e", type=str, nargs="+", default="sim")
    parser.add_argument("--furniture", "-f", type=str, default="one_leg", nargs="+")
    parser.add_argument(
        "--source",
        "-s",
        type=str,
    ...
    full_data_shapes = [
        ...
        ("depth_image2", all_data["depth_image2"].shape, np.uint8),
