...
def save_raw_rollout(
    ...
    for robot_state, image1, image2, parts_pose, six_dof_pose in zip(
        robot_states, imgs1, imgs2, parts_poses, six_dof_poses
    ):
        observations.append(
            {
